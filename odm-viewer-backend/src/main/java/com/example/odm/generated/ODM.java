...
/**
 * <p>
 * Java class for ODMcomplexTypeDefinition-ODM complex type.
 * 
 * <p>
...
public class ODM {
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the adminDatas
     * property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the referenceDatas
     * property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the clinicalDatas
     * property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the associations
     * property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
